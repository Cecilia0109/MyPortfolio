...
const ProjectItem = () => {
  return (
    <li className="relative list-none my-16">
      <a href="https://www.courtcanva.com/" className="flex justify-center md:gap-16  lg:gap-8 group/project transition duration-500 ease-in-out">
        <div className="relative before:projectBefore md:w-[40%] lg:w-[30%] before:group-hover/project:opacity-100">
          <Image
          ...
          <div className="flex gap-2 items-center justify-center h-full w-full">
            <Link href="https://github.com/courtcanva" className="linkBtn opacity-0 group-hover/project:opacity-100">Source Code</Link>
            <Link href="https://github.com/courtcanva" className="linkBtn opacity-0 group-hover/project:opacity-100">Download Link</Link>
          </div>
        </div>
        <div className="max-w-[40%] lg:max-w-[50%] border-t-[1px] border-borderBlack pt-4 relative before:projectInfoBefore before:group-hover/project:w-full duration-300 transition-transform">
          <h3 className="text-2xl pb-2 group-hover/project:text-yellow">CourtCanva</h3>
