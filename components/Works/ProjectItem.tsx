...
const ProjectItem = () => {
  return (
    <li className="relative list-none my-16">
      <a href="https://www.courtcanva.com/" className="flex justify-center flex-col md:flex-row gap-4 md:gap-16  lg:gap-8 group/project transition-all duration-500 ease-in-out">
        ...
        <div className="max-w-[90%] md:max-w-[40%] lg:max-w-[50%] border-t-[1px] border-borderBlack pt-4 relative before:projectInfoBefore before:group-hover/project:w-full duration-300 transition-transform">
      ...
      <a href="https://www.courtcanva.com/" className="absolute top-[60%] md:top-[18%] right-[10%] hover:scale-110 duration-300">
